...
SUBCHANNEL_SELECTOR = (By.XPATH,'//*[@id="8138d1a2-74d5-481c-8069-22c971158fc8_content"]/div/div/div/div/label[12]/input')
INSTITUTION_SELECTOR = (By.XPATH, '//*[@id="8138d1a2-74d5-481c-8069-22c971158fc8_content"]/div/div/div/div/label[2]/input')
CLAVE_CBYCM_SELECTOR = (By.XPATH, '//*[@id="8138d1a2-74d5-481c-8069-22c971158fc8_content"]/div/div/div/div/label[6]/input')
...
#CLASIFICAR LOS ELEMENTOS POR SUBCHANNEL
logging.info("Filtrando resultados por Subchannel")
while exceptions_count <= MAX_EXCEPTIONS_COUNT:
    try:
        WebDriverWait(web_driver, BASE_TIMEOUT_TIME)\
            .until(EC.presence_of_element_located(SUBCHANNEL_SELECTOR))
        WebDriverWait(web_driver, BASE_TIMEOUT_TIME) \
            .until(EC.element_to_be_clickable(SUBCHANNEL_SELECTOR))\
            .click()
        exceptions_count = 0
        break
    except Exception as e:
...
#CLASIFICAR LOS ELEMENTOS POR PRODUCTO
logging.info("Filtrando resultados por Producto")
WebDriverWait(web_driver, BASE_TIMEOUT_TIME)\
    .until(EC.presence_of_element_located(CLAVE_CBYCM_SELECTOR))
WebDriverWait(web_driver, BASE_TIMEOUT_TIME) \
    .until(EC.element_to_be_clickable(CLAVE_CBYCM_SELECTOR))\
    .click()
...
new_file_path = os.path.join(getenv("DOWNLOAD_DIRECTORY"), "output", "scrapping_altas", "dash_qlik.xlsx")
